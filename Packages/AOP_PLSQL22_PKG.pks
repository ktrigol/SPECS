create or replace package aop_plsql22_pkg
AUTHID CURRENT_USER
as
...
g_api_key  varchar2(200) := 'F5254B8705B42F2FE055043998A2C4EE';    -- change to your API key in APEX 18 or above you can use apex_app_setting.get_value('AOP_API_KEY')
