create or replace package aop_api22_pkg
AUTHID CURRENT_USER
as
...
--### Call to AOP 
g_aop_url                    varchar2(200) := 'http://api.apexofficeprint.com/';  -- AOP Server url 
g_api_key                    varchar2(50)  := 'F5254B8705B42F2FE055043998A2C4EE';  -- AOP API Key; only needed when AOP Cloud is used (http(s)://www.apexofficeprint.com/api) 
g_aop_mode                   varchar2(15)  := 'development';  -- AOP Mode can be development or production; when running in development no cloud credits are used but a watermark is printed
